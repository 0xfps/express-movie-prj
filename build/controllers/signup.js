...
const signupController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [isValidUsername, returnedUsername] = yield (0, exports.validateUsername)(username);
    const [isValidEmail, returnedMail] = (0, exports.validateEmail)(email);
    const [isValidPass, returnedPass] = (0, exports.validatePassword)(password);
